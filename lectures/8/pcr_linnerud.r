...
#setwd("E:/txt/docent/DMKM/KBLMM/2017-2018/Session 1 pcr/")
setwd("E:/docent/DMKM/KBLMM/2019-2020/Session 1 pcr/")
...
pcX$eig
windows()
plot(pcX$eig[,1],type="l", main="Screeplot")   #screeplot
...
# rotation of axes to find the latent concepts and to check the dimensionality

varimax(pcX$var$cor[,1:nd])

#############################################################################

# we store the loadings and scores in P and Psi
P = pcX$svd$V[,1:nd]
...
biplot(Psi,P,main="Biplot in Rp")
...
biplot(Psis,cor.VF,main="Biplot in Rn")
...
pcY$eig
windows()
plot(pcY$eig[,1],type="l", main="Screeplot")   #screeplot
...
# we store the loadings and scores in PY and PsiY
PY = pcY$svd$V[,1:nd]
